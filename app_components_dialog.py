# From https://github.com/emfcamp/badge-2024-software/pull/222
import asyncio

import display
from events.input import Button, BUTTON_TYPES, ButtonDownEvent
from system.eventbus import eventbus

from app_components.tokens import button_labels, label_font_size, set_color
...
def find_parent_in_group(button, group):
...
class TextDialog:
    ...
    def _handle_buttondown(self, event: ButtonDownEvent):
        print("_handle_buttondown", event)
        key = -1
        final = None

        kbd_button = find_parent_in_group(event.button, "Keyboard")
